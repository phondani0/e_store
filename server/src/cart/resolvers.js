const resolvers = {
    ...
    Mutation: {
        // @TODO: Handle the case where there are more than one cart items with same product. It appears when addToCart is called on product which is already in cart, then another cart item is getting created
